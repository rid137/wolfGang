        ...
        <>
            ...
            <div className="bg-greyBg p-7">
                <div className="flex justify-end mb-10">
                    <button className="bg-primary text-white px-4 py-2 rounded-md"><Link to="/editprofile">Edit Profile</Link></button>
                </div>
                ...
                <div className="bg-white p-4 mt-6 rounded-md">
                        <Link to="/security" className="flex gap-4 items-center text-md cursor-pointer">
                            <MdOutlineSecurity />
                            <p>Security</p>
                        </Link>     
                </div>
                ...
                <div className="bg-white p-4 mt-6 rounded-md text-md">
                        <Link to="/support" className="flex gap-4 items-center cursor-pointer">
                            <BsPersonLinesFill />
                            <p>Help &amp; Support</p>
                        </Link>
                        
                        <Link to="/privacy" className="flex gap-4 items-center mt-4 cursor-pointer">
                            <MdOutlinePrivacyTip />
                            <p>Privacy policy</p>
                        </Link>

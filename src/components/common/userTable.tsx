...
export function UserTable<TData, TValue>({columns, data}: ReactTableProps<TData, TValue>) {
    ...
    const table = useReactTable({
      ...
      return (
        ...
        <div className="mt-4 flex items-center justify-center gap-4 text-white text-[.6rem] md:text-[.8rem]">
            ...
            <button onClick={() => table.setPageIndex(table.getPageCount() - 1)} className="bg-primary text-white py-1 px-2 xs:py-2 xs:px-3 rounded-xl ">Last Page</button>
        </div>
